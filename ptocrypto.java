...
public class ptocrypto extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ptocrypto);
        ...
        encrypt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (ContextCompat.checkSelfPermission(ptocrypto.this,
                        Manifest.permission.READ_EXTERNAL_STORAGE)!= PackageManager.PERMISSION_GRANTED){
                    ActivityCompat.requestPermissions(ptocrypto.this,new String[]{
    ...
    private void selectPhoto() {
        ...
        startActivityForResult(Intent.createChooser(intent,"SelectPicture"),100);
    }
